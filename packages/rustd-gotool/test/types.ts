...
void [cv, fromLit, fromFLit, fromCLit, kind, ival, iok, sval, sok, fval, fok, icmp, fcmp, isign, ibits, badd, fadd, uxor, fneg, sshl, bstr, cmp, ok, lang, tok, kw, exp, s, scanner, err, parseErr, wrong, parsed, expr, id, exported];
