...
Go `mime`, `mime/quotedprintable`, and `mime/multipart` (Writer WriteField / CreateFormField / CreateFormFile / CreatePart, Reader NextPart / NextRawPart including 1-byte and mid-boundary `write`, Reader ReadForm part-count, non-file maxMemory, and file maxMemory throw) for Node via napi-rs.
...
Recorded after `napi build --platform --release` on linux-x64-gnu, Rust 1.97.1 (2026-09-14, checkpoint 26): **517,680 bytes** / 2,000,000.
