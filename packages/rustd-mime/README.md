...
Recorded after `napi build --platform --release` on linux-x64-gnu, Rust 1.97.1 (2026-09-14, checkpoint 22; no `.node` rebuild): **507,384 bytes** / 2,000,000.
