...
const decoded: AsyncIterable<Uint8Array> = lzwDecompressStream((async function* () { yield raw; })(), opts);
...
void [unzipped, stream, encoded, decoded, part, finished, format, lzwErr, cfg];
