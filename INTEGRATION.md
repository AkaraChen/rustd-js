...
| rustd-gotool | `pkg/rustd-gotool-grok-bulk-4` @ `3f67b99` | rejected — parallel rewrite vs merged `63cece8` (`63cece8` is **not** an ancestor; merge-base `ba259ea`). Float BinaryOp ADD/SUB/MUL/QUO. Worker must rebase |
